...
function ItemIcon(e, t) {
    ...
    var i = new createjs.Bitmap("media/icons" + e + ".png");
    i.x = 2,
    i.y = 2,
    i.scaleX = .5,
    i.scaleY = .5,
...
function Room(e, t) {
    ...
    e.artwork && void 0 !== e.artwork.background) {
        var i = new createjs.Bitmap("media/rooms/" + e.artwork.background);
    ...
    if (null != e.playerlist)
        for (a = 0; a < e.playerlist.length; a++)
            this.addPlayer(e.playerlist[a])
}
...
function createBalloon(e, t) {
    ...
    return a.graphics.setStrokeStyle(1).beginStroke("#888888").beginFill("#FFFFFF"),
    a.graphics.moveTo(5, 0).arcTo(r, 0, r, 5, 5).arcTo(r, i, r - 5, i, 5).lineTo(80, i).lineTo(70, i + 10).lineTo(70, i).arcTo(0, i, 0, i - 5, 5).arcTo(0, 0, 5, 0, 5),
    a.x = 0 - r / 2,
    a.y = -10,
    a
}
...
World.prototype.emit = function(e) {
    ...
    if ("object" == typeof this.events[e])
        for (r = (i = this.events[e].slice()).length,
        t = 0; t < r; t++)
            i[t].apply(this, a)
}
,
...
Room.prototype.addPlayer = function(e) {
    ...
    if (null == this.playerlist[t]) {
        ...
        this.player.playerId == e.i && (i.isLocal = !0),
        i.x = e.x,
        i.y = e.y;
...
function CritterContainer(e) {
    ...
    this.face.sprite = new createjs.Sprite(i,"smile4"),
    ...
    t.animations.shadow && (this.baseContainer.sprite = new createjs.Sprite(i,"shadow"),
...
CritterContainer.prototype.updateDirection = function(e) {
    ...
    this.slots) {
        ...
        if (i.children[0]) {
            var r = i.children[0]
              , a = r.name + e;
            itemData.animations[a] ? (r.gotoAndStop(a),
...
InventoryScreen.prototype.showIcons = function() {
    ...
    for (var r = 0; r < i.inventory.length; r++) {
        ...
        (n = new ItemIcon(a.itemId,a.slot)).click(function() {
            ...
            i.removeItem(this.slotId)) : (t.addItem(this.slotId, this.itemId),
            i.addItem(this.itemId)),
            e.updateIcons()
        }),
        this.icons.push(n)
    }
...
var critterData = {
  ...
  , itemData = {
    framerate: 10,
    frames: [[1, 1, 112, 129, 0, -12, -5], [1, 132, 112, 128, 0, -12, -1], [115, 1, 105, 126, 0, -1, -5], [1, 262, 105, 126, 0, -30, -5], [115, 129, 90, 126, 0, 0, -2], [115, 129, 90, 126, 0, 0, -2], [222, 1, 90, 126, 0, -46, -2], [222, 1, 90, 126, 0, -46, -2], [1, 390, 92, 89, 0, -22, -21], [207, 129, 92, 89, 0, -22, -21], [314, 1, 92, 89, 0, -22, -21], [1, 481, 92, 89, 0, -22, -21], [408, 1, 92, 89, 0, -22, -21], [502, 1, 92, 89, 0, -22, -21], [596, 1, 89, 89, 0, -22, -21], [596, 1, 89, 89, 0, -22, -21], [687, 1, 89, 89, 0, -25, -21], [687, 1, 89, 89, 0, -25, -21], [778, 1, 89, 89, 0, -22, -21], [778, 1, 89, 89, 0, -22, -21], [869, 1, 89, 89, 0, -22, -21], [869, 1, 89, 89, 0, -22, -21], [1, 572, 85, 61, 0, -24, -18], [207, 220, 88, 89, 0, -26, -21], [207, 220, 88, 89, 0, -26, -21], [314, 92, 88, 89, 0, -26, -21], [314, 92, 88, 89, 0, -26, -21], [404, 92, 86, 90, 0, -28, -20], [492, 92, 86, 90, 0, -22, -20], [580, 92, 86, 90, 0, -28, -20], [668, 92, 86, 87, 0, -22, -23], [756, 92, 86, 87, 0, -28, -23], [844, 92, 86, 87, 0, -22, -